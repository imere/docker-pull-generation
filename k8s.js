...
images = [
  ...
  [
    ['registry.cn-hangzhou.aliyuncs.com/google_containers/', 'kube-controller-manager', 'v1.14.3'],
    ['k8s.gcr.io/'],
  ],
  [
    ['registry.cn-hangzhou.aliyuncs.com/google_containers/', 'kube-scheduler', 'v1.14.3'],
    ['k8s.gcr.io/'],
  ],
  [
    ['registry.cn-hangzhou.aliyuncs.com/google_containers/', 'kube-proxy', 'v1.14.3'],
    ['k8s.gcr.io/'],
  ],
  [
    ['registry.cn-hangzhou.aliyuncs.com/google_containers/', 'kube-apiserver', 'v1.14.3'],
    ['k8s.gcr.io/'],
  ],
  [
